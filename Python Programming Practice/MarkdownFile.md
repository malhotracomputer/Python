...
**1️****⃣** **Print Statement Programs**

**1️****⃣** **प्रिंट** **स्टेटमेंट** **प्रोग्राम**
...
👉 Displays your name.👉 आपका नाम दिखाता है।
...
**_🎯_** **_Extra Practice (_****_थोड़ा_** **_और_** **_सीखें_****_)_**
...
**2️****⃣** **Variables Programs**

**2️****⃣** **वेरिएबल्स** **प्रोग्राम**
...
👉 Stores number in a variable.👉 एक संख्या को वेरिएबल में स्टोर करता है।
...
**_🎯_** **_Extra Practice_**

**1️****⃣** **Change the value:**
...
👉 Stores text in a variable.👉 टेक्स्ट को वेरिएबल में स्टोर करता है।
...
*   name = "Vicky"  
    → "Vicky" टेक्स्ट को name नाम के वेरिएबल में रखा गया है।→ टेक्स्ट को Python में **string (str)** कहते हैं।
*   print(name)  
    → वेरिएबल में रखी हुई वैल्यू को स्क्रीन पर दिखाता है।
...
👉 Uses multiple variables.👉 कई वेरिएबल्स का उपयोग करता है।
...
**3️****⃣** **Taking User Input**

**3️****⃣** **यूज़र** **से** **इनपुट** **लेना**
...
👉 Takes input from user.👉 यूज़र से इनपुट लेता है।
...
*   input("Enter your name: ")  
    → यूज़र से नाम पूछता है।→ यूज़र जो भी टाइप करता है, वह name वेरिएबल में स्टोर हो जाता है।
*   print("Hello", name)  
...
👉 Input is stored as string.👉 इनपुट स्ट्रिंग के रूप में स्टोर होता है।
...
✔ Even though we entered 25✔ It is still stored as string
...
**5️****⃣** **Arithmetic Programs**

**5️****⃣** **गणितीय** **प्रोग्राम**
